...
class AtualizarAbastecimentoPage extends StatefulWidget {
  AtualizarAbastecimentoPage(this.documentSnapshotAbastecimento, {super.key});
  DocumentSnapshot documentSnapshotAbastecimento;

  @override
  State<AtualizarAbastecimentoPage> createState() =>
      _AtualizarAbastecimentopageState();
}

class _AtualizarAbastecimentopageState
    extends State<AtualizarAbastecimentoPage> {
  ...
  var _user = FirebaseAuth.instance.currentUser!.uid.toString();
  bool loading = true;
  ...
  void initState() {
    setState(() {
      _user = FirebaseAuth.instance.currentUser!.uid.toString();
    });
  ...
  LoadDataForControllersAbastecimento() async {
    DateTime data1 =
        (widget.documentSnapshotAbastecimento['dataApontamento'] as Timestamp)
            .toDate();
  ...
  Widget build(BuildContext context) {
    ...
    if (setter == false) LoadDataForControllersAbastecimento();
    returnNomeUser(_user);
    return Scaffold(
      appBar: AppBar(
        actions: [],
                        ...
                        decoration: InputDecoration(
                          ...
                          enabledBorder: OutlineInputBorder(
                              borderSide: BorderSide(
                                  color: AppColors.fundoCard, width: 1.0),
                        ...
                        if (!snapshot.hasData) {
                          ...
                          for (var combustivel in combustiveis!) {
                            combustivelItens.add(DropdownMenuItem(
                                ...
                                child: Text(combustivel['nome'].toString())));
                          }
                        }
                          ...
                          builder: (context, snapshot) {
                            ...
                            return Container(
                              ...
                              child: DropdownButtonFormField(
                                  ...
                                  onChanged: (nome) {
                                    setState(() {
                                      returnEstoqueCombustivel(nome, "origem");
                          ...
                          builder: (context, snapshot) {
                            ...
                            if (!snapshot.hasData) {
                              ...
                              for (var destino in destinos!) {
                                destinosItens.add(DropdownMenuItem(
                                    value: destino.id,
                                    child: Text(destino['nome'].toString())));
                              }
                            }
                            return Container(
                              height: 48,
                              ...
                              child: DropdownButtonFormField(
                                  ...
                                  onChanged: (nome) {
                                    setState(() {
                                      returnEstoqueCombustivel(nome, "destino");
                                    });
                                  },
                  ...
                  Row(
                    children: [
                      ...
                      Expanded(
                          child: ElevatedButton(
                        onPressed: () {
                          if (dateController != '' && horaController != '') {
                            saveAbastecimento(
                                dataSelecionada,
